...
#define OLED_SCLK_Clr()  (GpioDataRegs.GPACLEAR.bit.GPIO9=1)//SCL
#define OLED_SCLK_Set()  (GpioDataRegs.GPASET.bit.GPIO9=1)

#define OLED_SDIN_Clr()  (GpioDataRegs.GPACLEAR.bit.GPIO8=1)//SDA
#define OLED_SDIN_Set()  (GpioDataRegs.GPASET.bit.GPIO8=1)
